(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [177],
  {
    ...
    1453: () => {},
    2183: (t, e, i) => {
      (Promise.resolve().then(i.t.bind(i, 9412, 23)),
        Promise.resolve().then(i.t.bind(i, 5700, 23)),
        Promise.resolve().then(i.t.bind(i, 5110, 23)),
        Promise.resolve().then(i.t.bind(i, 7636, 23)),
        Promise.resolve().then(i.t.bind(i, 6196, 23)),
        Promise.resolve().then(i.t.bind(i, 1453, 23)),
        Promise.resolve().then(i.t.bind(i, 347, 23)),
        Promise.resolve().then(i.bind(i, 8815)));
    },
    5110: (t) => {
      t.exports = {
        style: {
    ...
    7636: (t) => {
      t.exports = {
        style: { fontFamily: "'montrealMono', 'montrealMono Fallback'" },
    ...
    8815: (t, e, i) => {
        ...
        p = class {
          ...
          onWheel = (t) => {
            let { deltaX: e, deltaY: i, deltaMode: s } = t,
              o = 1 === s ? a : 2 === s ? this.window.width : 1,
              n = 1 === s ? a : 2 === s ? this.window.height : 1;
            ((e *= o),
              (i *= n),
        ...
        d = class {
          ...
          constructor({
            ...
            ((window.lenisVersion = "1.3.1"),
              ...
              (this.dimensions = new l(t, e, { autoResize: w })),
          ...
          checkNestedScroll(t, { deltaX: e, deltaY: i }) {
            ...
            if (
              ...
              return !1;
            if ("x" === p)
              ((d = t.scrollLeft), (u = l - a), (m = e), (v = s), (S = n));
            else {
              if ("y" !== p) return !1;
      ...
      function m(t) {
        ...
        return (
          ...
          (0, s.jsx)(u.v.Provider, { value: i, children: e })
        );
      }
    },
    9412: (t) => {
