  ...
  var t = {
      173: function (t, e) {
        !(function (t) {
          ...
          const y = new Set(),
            ...
            w = (t) => {
              if ("hidden" === document.visibilityState) {
                ...
                isFinite(h) ||
                  ((h = "visibilitychange" === t.type ? t.timeStamp : 0),
                ...
                const t = p(),
                  e = document.prerendering
                    ...
                    : globalThis.performance
                        ...
                        .find((e) => "hidden" === e.name && e.startTime >= t)
                        ?.startTime;
                ((h = e ?? T()),
          ...
          class R {
            ...
            u(t) {
              if (
                (this.p?.(t), !t.interactionId && "first-input" !== t.entryType)
              )
                return;
              const e = this.l.at(-1);
                ...
                for (let i = s.length - 1; i >= 0; i--) {
                  ...
                  if (Math.abs(n - o.renderTime) <= 8) {
                    ((r = o),
                      ...
                      (r.processingStart = Math.min(
                        t.processingStart,
                        r.processingStart,
                      )),
                      (r.processingEnd = Math.max(
                        t.processingEnd,
                        r.processingEnd,
                      )),
                      !1 !== e.includeProcessedEventEntries &&
                        r.entries.push(t));
                    break;
                  }
                }
                ...
                ((t, e = {}) => {
                  ...
                  S(() => {
                    "interactionCount" in performance ||
                      M ||
                      (M = m("event", I, { durationThreshold: 0 }));
                    let r,
                      i = g("INP");
                    const o = a(e, R),
                      s = (t) => {
                    ...
                    if (c) {
                      ...
                      const n = v(() => {
                        ...
                        o = (t) => {
                          t.isTrusted &&
                            (B(n),
                            removeEventListener(t.type, o, { capture: !0 }));
                        };
                      ...
                      if (t.entries.length) {
                        ...
                        if (s) {
                          const n = s.activationStart || 0,
                            ...
                            a = Math.min(
                              t.value,
                              Math.max(i, o ? o.responseEnd - n : 0),
                            );
                          e = {
                            ...e,
                            timeToFirstByte: r,
            ...
            (t.onTTFB = (t, e = {}) => {
              ((t, e = {}) => {
                ...
                q(() => {
                  const o = n();
                  o &&
                    ((r.value = Math.max(o.responseStart - p(), 0)),
                    (r.entries = [o]),
                    i(!0),
                    u(() => {
                      ((r = g("TTFB", 0)),
          ...
          (e.sendObjectBeacon = function (t, e, n, r = !1, i = null) {
            ...
            if (navigator && "string" == typeof navigator.userAgent)
              try {
                ...
                t &&
                  t[0].toLowerCase().indexOf("chrome") > -1 &&
                  parseInt(t[1]) < 81 &&
                  (s = !1);
              } catch (t) {}
            if (
        ...
        (Object.defineProperty(e, "__esModule", { value: !0 }),
          ...
          (e.buildTimingsObject = function (t, e, n) {
            for (const r of n) {
              const n = t[r];
              void 0 !== e &&
                (("number" != typeof n && "string" != typeof n) || (e[r] = n));
            }
          }),
          (e.timingsTargetKeys = [
            "navigationStart",
      ...
      791: (t, e, n) => {
        ...
        const r = "ffffffff-ffff-ffff-ffff-ffffffffffff",
          ...
          a = function (t) {
            ...
            return Uint8Array.of(
              ...
              (e >>> 8) & 255,
              255 & e,
              (e = parseInt(t.slice(9, 13), 16)) >>> 8,
              255 & e,
              (e = parseInt(t.slice(14, 18), 16)) >>> 8,
              255 & e,
        ...
        const v = function (t, e, n) {
          ...
          let a;
          const c =
            null !== (r = null == t ? void 0 : t._v6) && void 0 !== r && r;
          if (t) {
          ...
          if (t)
            a = m(
              null !==
                (s =
                  null !== (i = t.random) && void 0 !== i
                    ? i
                    : null === (o = t.rng) || void 0 === o
                      ? void 0
                      : o.call(t)) && void 0 !== s
                ? s
                : p(),
            ...
            (!(function (t, e, n) {
              ...
              ((null !== (r = t.msecs) && void 0 !== r) || (t.msecs = -1 / 0),
                ...
                e === t.msecs
                  ? (t.nsecs++,
                    t.nsecs >= 1e4 && ((t.node = void 0), (t.nsecs = 0)))
                  : e > t.msecs
                    ? (t.nsecs = 0)
                    : e < t.msecs && (t.node = void 0),
                t.node ||
        ...
        const I = U,
          ...
          O = function (t, e, n) {
            return !M.randomUUID || e || t
              ? (function (t, e, n) {
                  var r, i, o;
                  const s =
                    null !==
                      (o =
                        null !== (r = (t = t || {}).random) && void 0 !== r
                          ? r
                          : null === (i = t.rng) || void 0 === i
                            ? void 0
                            : i.call(t)) && void 0 !== o
                      ? o
                      : p();
        ...
        const _ = j,
          x = function (t, e, n) {
            (null != t || (t = {}), null != n || (n = 0));
            let r = v(
              Object.assign(Object.assign({}, t), { _v6: !0 }),
              new Uint8Array(16),
            );
            if (((r = h(r)), e)) {
                ...
                ((null !== (r = t.msecs) && void 0 !== r) || (t.msecs = -1 / 0),
                  ...
                  e > t.msecs
                    ? ((t.seq =
                      ...
                      (t.msecs = e))
                    : ((t.seq = (t.seq + 1) | 0), 0 === t.seq && t.msecs++));
              })(q, t, r),
      ...
      (() => {
        ...
        !(function () {
          const s =
            ...
            c =
              ...
              ("function" == typeof document.querySelector
                ? document.querySelector(`script[${a}]`)
                : void 0);
          let l,
            u,
            d = (0, i.v4)(),
          ...
          function T(t) {
            ...
            let c;
            switch (
              (m || (m = t.navigationType),
              "INP" !== t.name &&
                (y[t.name.toLowerCase()] = { value: t.value, path: a }),
              t.name)
            ) {
              case "CLS":
                ((c = t.attribution),
                  c &&
                    y.cls &&
                    ((y.cls.element = c.largestShiftTarget),
                    (y.cls.currentRect =
                      null === (e = c.largestShiftSource) || void 0 === e
                        ? void 0
                        : e.currentRect),
                    (y.cls.previousRect =
                      ...
                      null ===
                        (s =
                          null === (o = c.lcpEntry) || void 0 === o
                            ...
                            : o.element) || void 0 === s
                        ? void 0
                        : s.getAttribute("fetchpriority"))));
                break;
              case "INP":
                (null == y.inp || Number(y.inp.value) < Number(t.value)) &&
                  ((y.inp = { value: Number(t.value), path: a }),
                  (c = t.attribution),
                  c &&
                    y.inp &&
                    ((y.inp.element = c.interactionTarget),
          ...
          ("function" == typeof PerformanceObserver &&
            ...
            PerformanceObserver.supportedEntryTypes &&
              ...
              (0, r.onCLS)(T, { reportAllChanges: !0 })),
            document.addEventListener("visibilitychange", () => {
              if ("hidden" === document.visibilityState) {
                if (w && D()) {
                  const t = n();
                  (((null == g ? void 0 : g.url) == t &&
                    (null == g ? void 0 : g.triggered)) ||
                    S(),
                    A(t));
                }
                !v && g && ((v = !0), E());
          ...
          const w = p && (void 0 === p.spa || !0 === p.spa),
            ...
            S = (r) => {
              let i = (function (e) {
                  ...
                  if ("function" == typeof s.getEntriesByType) {
                    ...
                    if (t && Array.isArray(t) && t.length > 0) {
                      ((c.timingsV2 = {}),
                        ...
                        delete c.timings);
                      const e = t[0];
                      (0, o.buildTimingsObject)(
                        e,
                        c.timingsV2,
                        o.timingsV2TargetKeys,
                      );
                    }
                  }
                ...
                return (
                  (c.firstPaint = M("first-paint")),
                  (c.firstContentfulPaint = M("first-contentful-paint")),
                  p &&
                    (p.icTag && (c.icTag = p.icTag), (c.siteToken = p.token)),
                  void 0 !== l && (delete c.timings, delete c.memory),
                  c
                );
              })(r);
              i &&
                ...
                ((i.resources = []),
                p &&
                  ((0, e.sendObjectBeacon)("", i, () => {}, !1, b),
                  void 0 !== p.forward &&
                    void 0 !== p.forward.url &&
                    (0, e.sendObjectBeacon)(
                      "",
                      i,
                      () => {},
                      !1,
            ...
            E = () => {
              let r = (function () {
                ...
                try {
                  r =
                    "function" == typeof s.getEntriesByType
                      ? new URL(null == e ? void 0 : e.name).pathname
                      : u
                        ? new URL(u).pathname
                ...
                return (
                  p &&
                    (p.version && (i.versions.fl = p.version),
                    p.icTag && (i.icTag = p.icTag),
                    (i.siteToken = p.token)),
                  y &&
                    ["lcp", "cls", "fcp", "ttfb", "inp"].forEach((t) => {
                      ((i[t] = { value: -1, path: void 0 }),
          ...
          const D = () => w && 0 === f.filter((t) => t.id === d).length,
            A = (t) => {
              (f.push({ id: d, url: t, ts: new Date().getTime() }),
                f.length > 3 && f.shift());
            };
          function P() {
            return s.timeOrigin;
            ...
            if ("function" == typeof s.getEntriesByType) {
              ...
              ((t.timingsV2 = {}),
                e &&
                  e[0] &&
                  (e[0].nextHopProtocol &&
                    (n.nextHopProtocol = e[0].nextHopProtocol),
                  e[0].transferSize && (n.transferSize = e[0].transferSize),
                  e[0].decodedBodySize &&
                    (n.decodedBodySize = e[0].decodedBodySize),
